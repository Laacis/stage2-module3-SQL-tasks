...
('John', DATE('2010-01-01'), 1),
('Chris',DATE('2010-02-02'), 1),
('Carl', DATE('2010-03-03'), 1),
('Oliver', DATE('2009-03-04'), 2),
('James', DATE('2009-07-29'), 2),
('Lucas', DATE('2009-05-04'), 2),
('Henry', DATE('2009-11-23'),2),
('Jacob', DATE('2009-05-09'), 3),
('Logan', DATE('2009-03-12'),3),
('Eva',DATE('2008-02-24'), 4),
('Adolf', DATE('2008-07-23'), 4),
('Ahmed', DATE('2008-12-04'), 4),
('Margo', DATE'2007-04-03'(), 5),
('Jose', DATE('2007-05-13'), 5),
('Ed', DATE('2007-01-13'), 5);
